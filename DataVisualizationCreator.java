...
public class DataVisualizationCreator {
	...
	public void createCharts(String[][] tradeResults) {
		histogram = Histogram.getInstance();
		createTableOutput(tradeResults);
		createBar(tradeResults);
	}

	
	// action table
	private void createTableOutput(String[][] results) {
		
		// Dummy dates for demo purposes. These should come from selection menu
		Object[] columnNames = {"Trader","Strategy","CryptoCoin","Action","Quantity","Price","Date","Status"};
	...
	private void createBar(String[][] results) {
...
//		You will have to come up with a proper datastructure to populate the BarChart with live data!
		...
		histogram.updateDataset(results);
		DefaultCategoryDataset dataset = histogram.getDataset();
