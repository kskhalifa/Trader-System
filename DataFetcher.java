...
/** This class is utilized to communicate with the coingecko API to retrieve relevant information with regards to a given entry list of crypto currencies.
*/
public class DataFetcher {
	...
	/** Getter Method for accessing the given price of a crypto coin
	* <p>
	* @param id the id of a given coin
	* @param date The current date and time
	* @return price The price of the coin to return
	*/
	...
	/** Getter Method for accessing the given Market Cap of a crypto coin
	* <p>
	* @param id the id of a given coin
	* @param date The current date and time
	* @return marketCap The market Cap of the coin to return
	*/
	...
	* @param id the id of a given coin
	* @param date The current date and time
	* @return volume The volume of the coin to return
	*/
